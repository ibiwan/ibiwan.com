(function($){
  $(function(){
    ...
    var substitutions = [
        {semantic:'j-main-navbar',   styling:['lighten-1', secondary_color],                              remove:[default_color]},
        {semantic:'j-headline',      styling:['header', 'center', primary_text_color],                    remove:[]},
        {semantic:'j-action-button', styling:['btn-large', 'waves-effect', 'waves-light', primary_color], remove:[default_color]},
        {},
        {},
        {},
    ];
    ...
    $('.j-column').addClass('col s12 m4');
    $('.j-column-header').addClass('center');
